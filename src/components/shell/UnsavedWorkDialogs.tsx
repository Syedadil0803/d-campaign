...
/**
 * The dialogs that stand in front of an action because something would be
 * lost: unsaved work, a full variant list, a publish about to go live.
 *
 * Each one interrupts a decision the user has already made, so each says what
 * is at stake and offers a way through rather than only a way back.
 */
